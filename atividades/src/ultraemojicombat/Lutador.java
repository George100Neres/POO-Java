...
public class Lutador {
 // Atributos
	...
	public void status() {
		...
		System.out.println(this.getVitorias() + "vezes");
		System.out.println(this.getDerrotas() + "vezes");
		System.out.println(this.getEmpates() + "vezes");
	...
	public String getCategoria() {
	 ...
	 // Categoria de Peso dos lutadores
