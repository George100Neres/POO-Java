...
public class DesafioFilter {
	...
	Produto p3 = new Produto("Impressora", 30, 0.45, 0);
	Produto p4 = new Produto("Ipad", 1200, 0.40, 0);
	Produto p5 = new Produto("Mobile", 3100, 0.29, 0);
	Produto p6 = new Produto("Relogio", 1900, 0.12, 10);
	Produto p7 = new Produto("Monitor", 800, 0.31, 10);
